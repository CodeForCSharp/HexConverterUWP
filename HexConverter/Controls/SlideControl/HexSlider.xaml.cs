using HexConverter.SlideControl;
using System;
...
namespace HexConverter.SliderControl
{
    ...
    public partial class HexSlider
    {
        ...
        public int Maxium { get; set; }

        private readonly List<HexThumb> _thumbExs;
        private readonly Dictionary<int, SolidColorBrush> _colors;

        public double ContentWidth => ActualWidth < 30 ? 0 : ActualWidth - 30;
        ...
        private void BuildRange()
        {
            ...
            for (int index = Maxium - 1; index >= 0; index--)
            {
                ...
                {
                    label.Text = binFormat[index].ToString();
                }
            }
        ...
        private void BuildMultiRange()
        {
            ...
            for (int i = 0; i < _rectangles.Count - 1; i++)
            {
                ...
                var thumb = new HexThumb(leftRect, rightRect, this);
        ...
        public void DragCompleted(HexThumb hexSliderThumbBase, int leftValue, int rightValue)
        {
